		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dealer Registeration",
									"targetURL": "#yamahaoofuiselfregister-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"yamahaoofuiselfregister-display": {
								"semanticObject": "yamahaoofuiselfregister",
								"action": "display",
								"description": "A Fiori application for self registering dealer",
								"title": "Dealer Registeration",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=yamaha.oof.uiselfregister",
									"url": sap.ui.require.toUrl("yamaha/oof/uiselfregister")
								}
							}
						}
					}
